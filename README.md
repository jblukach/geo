...
- `MOMENTO_SORTED_SET_BATCH_SIZE`: number of rows buffered before a bulk sorted-set write is sent to Momento. Default: `5000`.
- `MOMENTO_SORTED_SET_MIN_INTERVAL_SECONDS`: minimum delay between Momento requests. Default: `1.0`.
- `MOMENTO_SECRET_NAME`
- `MOMENTO_SECRET_KEY`
- `MOMENTO_SET_PREFIX`
- `MOMENTO_RELEASE`
